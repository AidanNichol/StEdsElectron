...
class EditMemberData extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      bacs: false,
      member: mem || {},
      subsStatus: Member.getSubsStatus(mem.status, mem.subscription),
    };
  ...
  render() {
    ...
    class SelectRole extends React.Component {
      constructor(props) {
        super(props);
        this.state = { roles: props.roles || '', disabled: props.disabled };
        logit('SelectRoles', props);
      }
      render() {
        return (
          <div className="section">
            <Select
              ...
              placeholder=""
              isDisable={this.state.disabled}
              removeSelected
              backspaceRemovesValue={false}
              simpleValue
              value={this.state.roles}
            />
            {/* // value={(props.roles || '').split(/, +/)} */}
          </div>
        );
      }
    }
