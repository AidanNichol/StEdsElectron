  ...
  <div className="payments-help">
    <dl>
      ...
      <dd>
        ...
        This can also be payment for future, unspecified walks that have not yet been booked, i.e. purchasing credits.
        Enter the net amount receieved, e.g. if a member has a cheque for £40 but has forgotten they have a credit
        and you give them £8 cash as change then just enter £32.
      </dd>
      <dt><Icon type="PX"/> Refund Payment</dt>
      <dd>
          Use this option where money has been handed over to the member in order
      ...
      <dd>
        ...
        recieved from the member, e.g. credits have been allowed in some special circumstance. It may also be necessary
        to use this to adjust for errors in this system.
      </dd>
    ...
    a transaction has been entered by mistake it can be negated by using the other member of the pair. When this is done
    simply enter the same amount as in the original entry (it is no longer necessary to enter negative values)
    <h4>Note</h4>
    <p>
      When taking payments a pot of cash and cheques is being accumulated to be handed
      over to the treasurer. The first two options in this list, <Icon type="P" height="15px"/> & <Icon type="PX" height="15px"/>, should be used if, and
      only if, it affects that pot of money. It should be possible to reconcile the pot of
      money with the sum of these transactions.
    </p>
  </div>
);
